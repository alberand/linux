...
DEFINE_IMETA_UPDATE_EVENT(xfs_imeta_commit);
DEFINE_IMETA_UPDATE_EVENT(xfs_imeta_cancel);
DEFINE_IMETA_UPDATE_EVENT(xfs_imeta_try_create);
DEFINE_IMETA_UPDATE_EVENT(xfs_imeta_create);
DEFINE_IMETA_UPDATE_EVENT(xfs_imeta_link);
...
DEFINE_EVENT(xfs_imeta_dir_class, name, \
	TP_PROTO(struct xfs_inode *dp, struct xfs_name *name, \
		 xfs_ino_t ino), \
	TP_ARGS(dp, name, ino))
DEFINE_IMETA_DIR_EVENT(xfs_imeta_lookup_component);
