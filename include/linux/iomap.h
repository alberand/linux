 ...
 *
 * IOMAP_F_READ_VERITY indicates that the iomap needs fs-verity verification
 * against Merkle tree
 */
...
struct iomap_folio_ops {
	...
	/*
	 * Verify folio against fs-verity Merkle tree after page was read to the
	 * cache
	 */
	bool (*verify_folio)(struct folio *folio, loff_t pos, unsigned len);
};
...
struct iomap_readpage_ops {
	 ...
	 * submitting the bio and/or override the bio end_io handler for
